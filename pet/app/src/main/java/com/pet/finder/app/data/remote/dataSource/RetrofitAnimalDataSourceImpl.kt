...
import com.pet.finder.app.data.remote.model.AnimalResponse
...
//        }
    ...
    override suspend fun getAnimal(id: Int): Animal {
        val animalResponse: AnimalResponse = animalService.getAnimalById(id).animal
        return responseAnimalToModel(animalResponse)
...
//        )
    ...
    private suspend fun responseAnimalToModel(animalResponse: AnimalResponse): Animal {
        val address = animalResponse.contact.address
        val detailsResponse = listOf(
            Details(key = "size", value = animalResponse.size),
            Details(key = "breed", value = parseBreeds(breeds = animalResponse.breeds))
